# File: utils.py
"""
Helper functions for building the SmartBill payload from Stripe event data.
"""
...
def extract_client_details(stripe_data):
    ...
    # Check if there is at least one tax id; if not, use default.
...
def build_payload(stripe_data, config):
    ...
    Omits payment details in TEST_MODE.
    """
